...
func (x *TestOneOfMsg) Reset() {
	*x = TestOneOfMsg{}
	mi := &file_tests_harness_cases_oneofs_proto_msgTypes[0]
...
func (*TestOneOfMsg) Descriptor() ([]byte, []int) {
	return file_tests_harness_cases_oneofs_proto_rawDescGZIP(), []int{0}
}
...
func (x *OneOfNone) Reset() {
	*x = OneOfNone{}
	mi := &file_tests_harness_cases_oneofs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OneOfNone) Descriptor() ([]byte, []int) {
	return file_tests_harness_cases_oneofs_proto_rawDescGZIP(), []int{1}
}
...
func (x *OneOf) Reset() {
	*x = OneOf{}
	mi := &file_tests_harness_cases_oneofs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OneOf) Descriptor() ([]byte, []int) {
	return file_tests_harness_cases_oneofs_proto_rawDescGZIP(), []int{2}
}
...
func (x *OneOfRequired) Reset() {
	*x = OneOfRequired{}
	mi := &file_tests_harness_cases_oneofs_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OneOfRequired) Descriptor() ([]byte, []int) {
	return file_tests_harness_cases_oneofs_proto_rawDescGZIP(), []int{3}
}
...
func (x *OneOfIgnoreEmpty) Reset() {
	*x = OneOfIgnoreEmpty{}
	mi := &file_tests_harness_cases_oneofs_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OneOfIgnoreEmpty) Descriptor() ([]byte, []int) {
	return file_tests_harness_cases_oneofs_proto_rawDescGZIP(), []int{4}
}
...
var File_tests_harness_cases_oneofs_proto protoreflect.FileDescriptor

const file_tests_harness_cases_oneofs_proto_rawDesc = "" +
	"\n" +
	" tests/harness/cases/oneofs.proto\x12\x13tests.harness.cases\x1a\x17validate/validate.proto\")\n" +
	"\fTestOneOfMsg\x12\x19\n" +
	"\x03val\x18\x01 \x01(\bB\a\xfaB\x04j\x02\b\x01R\x03val\"0\n" +
	"\tOneOfNone\x12\x0e\n" +
	...
	"\x05OneOf\x12\x1a\n" +
	"\x01x\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05:\x03fooH\x00R\x01x\x12\x17\n" +
	"\x01y\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00H\x00R\x01y\x121\n" +
	"\x01z\x18\x03 \x01(\v2!.tests.harness.cases.TestOneOfMsgH\x00R\x01zB\x03\n" +
	"\x01o\"\x9e\x01\n" +
	...
	"\x01o\x12\x03\xf8B\x01\"q\n" +
	"\x10OneOfIgnoreEmpty\x12\x1c\n" +
	"\x01x\x18\x01 \x01(\tB\f\xfaB\tr\a\x10\x03\x18\x05\xd0\x01\x01H\x00R\x01x\x12\x1b\n" +
	"\x01y\x18\x02 \x01(\fB\v\xfaB\bz\x06\x10\x03\x18\x05p\x01H\x00R\x01y\x12\x1d\n" +
	"\x01z\x18\x03 \x01(\x05B\r\xfaB\n" +
...
var (
	file_tests_harness_cases_oneofs_proto_rawDescOnce sync.Once
	file_tests_harness_cases_oneofs_proto_rawDescData []byte
)

func file_tests_harness_cases_oneofs_proto_rawDescGZIP() []byte {
	file_tests_harness_cases_oneofs_proto_rawDescOnce.Do(func() {
		file_tests_harness_cases_oneofs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tests_harness_cases_oneofs_proto_rawDesc), len(file_tests_harness_cases_oneofs_proto_rawDesc)))
	})
	return file_tests_harness_cases_oneofs_proto_rawDescData
}

var file_tests_harness_cases_oneofs_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_tests_harness_cases_oneofs_proto_goTypes = []any{
	...
	(*OneOfIgnoreEmpty)(nil), // 4: tests.harness.cases.OneOfIgnoreEmpty
}
var file_tests_harness_cases_oneofs_proto_depIdxs = []int32{
...
func init() { file_tests_harness_cases_oneofs_proto_init() }
func file_tests_harness_cases_oneofs_proto_init() {
	if File_tests_harness_cases_oneofs_proto != nil {
		return
	}
	file_tests_harness_cases_oneofs_proto_msgTypes[1].OneofWrappers = []any{
		(*OneOfNone_X)(nil),
		(*OneOfNone_Y)(nil),
	}
	file_tests_harness_cases_oneofs_proto_msgTypes[2].OneofWrappers = []any{
		(*OneOf_X)(nil),
		(*OneOf_Y)(nil),
		(*OneOf_Z)(nil),
	}
	file_tests_harness_cases_oneofs_proto_msgTypes[3].OneofWrappers = []any{
		(*OneOfRequired_X)(nil),
		(*OneOfRequired_Y)(nil),
		(*OneOfRequired_NameWithUnderscores)(nil),
		(*OneOfRequired_UnderAnd_1Number)(nil),
	}
	file_tests_harness_cases_oneofs_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tests_harness_cases_oneofs_proto_rawDesc), len(file_tests_harness_cases_oneofs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tests_harness_cases_oneofs_proto_goTypes,
		DependencyIndexes: file_tests_harness_cases_oneofs_proto_depIdxs,
		MessageInfos:      file_tests_harness_cases_oneofs_proto_msgTypes,
	}.Build()
	File_tests_harness_cases_oneofs_proto = out.File
	file_tests_harness_cases_oneofs_proto_goTypes = nil
	file_tests_harness_cases_oneofs_proto_depIdxs = nil
}
